...
/// C&C-specific orchestration helpers (large private functions).
mod orchestrate;
#[cfg(feature = "torrent")]
use orchestrate::{download_coordinated, download_via_librqbit};
use orchestrate::{resolve_package_mirrors, write_content_manifest};
...
use self::segmented::segmented_download;
